...
syms DISTANCE_LINK_1 DISTANCE_LINK_2 DISTANCE_LINK_3 DISTANCE_LINK_4 DISTANCE_LINK_5 DISTANCE_LINK_6
...
T56 = Transform(sym(-pi/2), DISTANCE_LINK_5, 0, theta6);
T67 = Transform(0, DISTANCE_LINK_6, 0, 0);
...
variables = [DISTANCE_LINK_1,DISTANCE_LINK_2,DISTANCE_LINK_3,DISTANCE_LINK_4,DISTANCE_LINK_5,DISTANCE_LINK_6,theta1,theta2,theta3,theta4,theta5,theta6];
values = [8,7,8,3,5,6,0.6,0.3,0.9,0.2,0.1,0.6];
